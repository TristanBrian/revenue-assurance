    ...
    return (
      <div className="flex flex-col gap-6 max-w-5xl mx-auto text-zinc-800 dark:text-zinc-100">
        ...
        <div className="bg-white dark:bg-zinc-900/35 border border-zinc-200 dark:border-zinc-900 rounded-xl p-6 flex flex-col gap-4 shadow-sm">
          <h2 className="text-base font-bold text-zinc-800 dark:text-white">Welcome, {user.email}</h2>
                    ...
                    <div className="flex flex-col divide-y divide-zinc-100 dark:divide-zinc-900/60">
                      {sortedOmcs.map((omc) => (
                        <div key={omc.customer} className="flex justify-between items-center py-3.5 first:pt-0 last:pb-0">
                          <div>
                            <h3 className="text-sm font-bold text-zinc-855 dark:text-white">{omc.customer}</h3>
      ...
      {showUploadModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl w-full max-w-lg p-6 shadow-2xl relative">
            ...
            <div className="mb-4">
              <h3 className="text-base font-bold text-zinc-900 dark:text-white">Upload reconciliation datasets</h3>
              <p className="text-xs text-zinc-500 dark:text-zinc-400">Drag or select a custom Gantry waybill CSV to run custom checks</p>
            </div>
