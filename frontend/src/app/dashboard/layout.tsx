    ...
    icon: (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M9 17v-2a4 4 0 014-4h4m0 0l-3-3m3 3l-3 3M4 7h16M4 7a2 2 0 002 2h12a2 2 0 002-2M4 7a2 2 0 012-2h12a2 2 0 012 2"
        />
      </svg>
    ),
  },
...
function DashboardLayoutContent({ children }: { children: React.ReactNode }) {
  ...
  const visibleItems = NAV_ITEMS.filter(
    (item) =>
      !item.anyOf ||
      item.anyOf.some((code) => user?.permissions.includes(code)),
  );
